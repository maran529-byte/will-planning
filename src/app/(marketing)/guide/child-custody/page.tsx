...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      'zh-CN': 'https://aiwill-planner.cn/guide/child-custody',
      'zh-HK': 'https://aiwill-planner.cn/guide/child-custody',
      'x-default': 'https://aiwill-planner.cn/guide/child-custody',
    },
  },
};
  ...
  return (
    <GuideArticle
      ...
      faqs={[
        {
          q: '抚养费一般按什么标准计算?',
          a: '根据最高人民法院的司法解释, 有固定收入的: 月总收入的20-30%; 负担两个以上子女的, 比例可适当提高, 一般不超过月总收入的50%; 无固定收入的: 参照当年总收入或同行业平均工资, 按上述比例确定. 抚养费包含生活费、教育费、医疗费.',
        },
        {
          q: '法院判决抚养权主要考虑哪些因素?',
          a: '一般原则: 2周岁以下原则上随母亲生活; 2-8周岁综合考量父母经济、稳定、生活环境、子女习惯等; 8周岁以上会尊重子女真实意愿. 核心考量: 谁抚养更有利于子女的身心健康和成长.',
        },
        {
          q: '对方拒绝配合探视, 如何强制执行?',
          a: '可向法院申请强制执行. 法院可采取罚款、拘留等强制措施; 情节严重的, 可变更抚养权. 建议保留阻碍探视的证据 (录音、录像、证人证言等), 必要时申请人身安全保护令. 同时可申请探视监督.',
        },
        {
          q: '子女教育规划应如何约定?',
          a: '建议明确: 1) 公立/私立学校的选择决策机制; 2) 兴趣班、培训费的分摊; 3) 海外教育/留学的费用承担; 4) 重大培训 (如体育、艺术) 的预算上限; 5) 父母对教育理念不一致时的处理程序, 如优先尊重直接抚养方意见.',
        },
        {
          q: '协议签订后, 抚养安排还能调整吗?',
          a: '可以. 协议签订后出现新情况 (如物价指数变化超10%、子女教育阶段变化、支付方收入变化超30%等), 任何一方可起诉至法院请求变更. 协议中应明确「调整条件」, 避免事后因补偿标准产生争议.',
        },
        {
          q: '祖父母/外祖父母是否有探视权?',
          a: '法理上有争议, 但司法实践中, 法院倾向于支持. 根据民法典公序良俗原则, 祖辈与孙辈之间存在天然亲情, 在不影响未成年人正常生活、学习的前提下, 隔代探视通常被支持. 协议中可明确祖辈探视的频次与安排.',
        },
      ]}
    >
      <section>
      ...
      <section>
        ...
        <p>
          ...
          {' '}: ¥19.9 系统化生成 (含抚养费计算器, 探视日历); 复杂场景 (跨境 / 股权 / 大额资产) 可
