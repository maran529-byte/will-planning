...
export const metadata: Metadata = {
  title: '常见问题 - 家有所爱',
  description: '家有所爱平台常见问题：如何使用、6 类家庭文书的区别、付款与发票、隐私与数据安全、专家护航服务流程。',
...
const FAQ_GROUPS = [
  {
    ...
    items: [
      ...
      { q: '一份文书需要多长时间？', a: '系统化问卷约 10 分钟，AI 生成草稿约 1 分钟，专家护航版额外 1-3 个工作日由资产规划专业人士审核。' },
      { q: '生成的文书有法律效力吗？', a: '智能版（¥19.9 起）为参考模板；建议办理公证或由专业律师审核；涉及大额财产建议升级专家护航版。' },
    ],
  },
  {
    title: '账户与付款',
    items: [
      ...
      { q: '专家护航版（¥999）的差异？', a: '在智能版基础上，由真实资产规划专业人士 1v1 审核全文 + 提供签署指引 + 一次免费修订。' },
    ],
  },
  {
    title: '隐私与数据',
    items: [
      { q: '我的数据存哪里？', a: '中国大陆腾讯云 CVM，自建 Supabase 集群；PII 字段 AES-256 加密；不出境。' },
