...
const (
	...
	EventContractSign     EventType = "contract.sign"
...
// Service provides audit logging as an injectable dependency.
type Service struct {
	logger *Logger
}
...
// LogContractGenerate logs a contract generation event.
