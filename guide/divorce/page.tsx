...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      'zh-CN': 'https://aiwill-planner.cn/guide/divorce',
      'zh-HK': 'https://aiwill-planner.cn/guide/divorce',
      'x-default': 'https://aiwill-planner.cn/guide/divorce',
    },
  },
};
  ...
  return (
    <GuideArticle
      ...
      faqs={[
        {
          q: '经过公证的离婚协议具备法律效力吗?',
          a: '具备. 协议离婚需经民政局备案, 公证并非强制. 但经过公证的离婚协议具有更强的证明效力, 出现纠纷时法院通常直接采信. 涉外、涉大额财产、涉股权等复杂情形下建议办理协议公证.',
        },
        {
          q: '一方隐瞒或转移财产, 如何处理?',
          a: '可以主张该方少分或不分. 离婚后发现对方存在隐瞒、转移、变卖、毁损、挥霍夫妻共同财产的行为, 可向法院起诉请求再次分割, 时效为发现之日起三年. 建议起诉前委托律师调查银行流水、房产交易、股权变更等记录.',
        },
        {
          q: '对方拒绝探视孩子, 怎么办?',
          a: '可起诉至法院. 探视权既是权利也是义务, 不直接抚养方不探视的不能强制, 但直接抚养方阻碍对方探视的, 法院可采取罚款、拘留等强制措施; 情节严重的, 可变更抚养权. 同时建议申请人身安全保护令.',
        },
        {
          q: '抚养费一般按什么标准计算?',
          a: '有固定收入的: 月总收入的20-30%; 负担两个以上子女的, 比例可适当提高, 一般不超过50%; 无固定收入的: 参照当年总收入或同行业平均工资, 按上述比例确定. 抚养费包含生活费、教育费、医疗费, 一般按月支付.',
        },
        {
          q: '协议离婚30天冷静期是如何计算的?',
          a: '根据2021年实施的《民法典》, 自民政局收到离婚申请之日起30天内为冷静期, 任一方不愿离婚的可以撤回; 冷静期届满后30天内, 双方应共同到民政局申请发给离婚证, 逾期未申请视为撤回. 整个流程最短约30天, 最长约60天.',
        },
        {
          q: '财产分割最容易出现的错误有哪些?',
          a: '常见错误包括: 1) 仅写「其他无争议」, 未穷尽列举财产, 导致漏分; 2) 未明确房屋贷款偿还方与过户安排; 3) 未约定公积金、养老保险个人账户分割; 4) 未对债务承担作清晰约定, 引发第三方追偿; 5) 未考虑子女教育、特殊医疗等大额支出.',
        },
      ]}
    >
      <section>
