      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-4 py-10 sm:py-14">
        ...
        <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm space-y-6 text-slate-700">
          <section>
            ...
            <p>
              在中国, 超过 60% 的成年人从未立过遗嘱. 原因不是「不需要」, 而是「不知道从何开始」,「觉得律师太贵」,「忌讳谈生死」.
            </p>
            <p className="mt-3">
            ...
            <p className="mt-3">
              我们的使命: 用 AI + 互联网, 把「立遗嘱」这件事的门槛从「万元 + 数周」降到「百元 + 数小时」.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <TeamCard emoji="⚖️" name="律师团队" role="执业律师" desc="5+ 年家事继承方向执业经验, 来自上海, 北京, 广州" />
              <TeamCard emoji="🤖" name="AI 工程师" role="全栈" desc="熟悉大模型应用, 数据合规, 个人信息保护" />
          ...
          <section>
            ...
            <ul className="space-y-2">
              <li className="flex gap-2">
                ...
                <span><strong>价格透明</strong>: AI 智能版 ¥19.9, 专家护航版 ¥999, 无隐藏费用</span>
              </li>
              <li className="flex gap-2">
                <span className="text-emerald-500 flex-shrink-0">✓</span>
                <span><strong>AI + 律师双保险</strong>: 纯 AI 不放心? 加 ¥980 让律师 1 对 1 审</span>
              </li>
              <li className="flex gap-2">
                <span className="text-emerald-500 flex-shrink-0">✓</span>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1 mt-2">
              <li><strong>不替代律师</strong>: 复杂家庭关系 (再婚, 跨境资产, 家族信托) 请直接找律师面谈</li>
          ...
          <section className="bg-amber-50 rounded-lg p-5 text-center">
            ...
            <p className="text-sm text-amber-800 mb-3">商务合作 / 律师加盟 / 媒体报道, 欢迎联系</p>
