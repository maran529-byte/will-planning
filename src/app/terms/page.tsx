        ...
        <div className="prose prose-slate max-w-none text-slate-700 space-y-6">
          <section className="bg-amber-50 border border-amber-200 rounded-lg p-4 text-sm">
            ...
            <p className="text-amber-800">
              ...
              涉及不动产, 大额资产, 复杂家庭关系的, 请务必咨询执业律师并办理公证.
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>AI 辅助的资产规划问卷与文书生成参考</li>
              <li>执业律师咨询对接 (用户支付后由律师主动联系)</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li><strong>AI 智能版</strong>: ¥19.9 - AI 自动生成文书参考</li>
              <li><strong>专家护航版</strong>: ¥999 - AI 文书 + 执业律师 1 对 1 审核 + 修改建议</li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li><strong>已生成文书</strong>: 律师未审核前可申请 50% 退款 (覆盖 AI 服务成本)</li>
              <li><strong>律师已审核</strong>: 不支持退款 (服务已完成)</li>
          ...
          <section>
            ...
            <p>本平台的所有内容 (含 AI 生成的文书模板, UI, 文案, 商标) 著作权归「爱的延续工作室」所有.</p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>因第三方服务 (微信, 支付通道, AI 服务) 故障导致的服务异常</li>
              <li>因您不当使用 AI 文书而造成的法律后果</li>
            </ul>
          </section>
