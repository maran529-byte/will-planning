...
export const metadata: Metadata = {
  ...
  description: '家有所爱隐私政策: 详细说明我们如何收集 / 使用 / 保护您的个人信息, 业务数据由 Supabase 海外节点提供, 符合《个人信息保护法》《数据安全法》, 30 天可申请删除.',
  keywords: ['隐私政策', '个人信息保护', '家有所爱', '数据安全', '隐私协议', 'PII 加密'],
  openGraph: {
    title: '家有所爱隐私政策 - 您的个人信息, 我们这样保护',
    description: '数据由 Supabase 海外节点提供, PII 字段 AES-256 加密, 30 天可申请彻底删除, 完整披露第三方共享清单.',
  ...
  alternates: {
    ...
    languages: {
      'zh-CN': 'https://aiwill-planner.cn/privacy',
      'zh-HK': 'https://aiwill-planner.cn/privacy',
      'x-default': 'https://aiwill-planner.cn/privacy',
    },
  },
};
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-4 py-10 sm:py-14">
        ...
        <div className="prose prose-slate max-w-none text-slate-700 space-y-6">
          ...
          <section>
            ...
            <p>
              业务数据由 <strong>Supabase (PostgreSQL + RLS)</strong> 提供, 海外节点 (新加坡 / 美西);
              静态站点部署于 <strong>Vercel CDN</strong> (海外节点); 主域名 ICP 备案指向大陆 CNAME.
              我们采取以下措施保护您的数据:
            </p>
            <ul className="list-disc pl-6 space-y-1">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li><strong>系统服务</strong>: 暂未启用第三方 AI 服务 (生成式 AI 服务备案申请中, 期间仅使用自研规则引擎 + 模板化文书生成)</li>
              <li><strong>云服务</strong>: Supabase (数据库 / 鉴权 / 存储), Vercel (静态站点部署), Cloudflare (CDN, 仅静态资源)</li>
