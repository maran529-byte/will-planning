...
export const metadata: Metadata = {
  title: '服务条款 - 家有所爱用户协议',
  description: '家有所爱服务条款: 套餐价格 (智能版 ¥19.9), 定制服务流程, 退款规则, 博主反作弊条款, 免责声明. 使用前请仔细阅读.',
  ...
  alternates: {
    ...
    languages: {
      'zh-CN': 'https://aiwill-planner.cn/terms',
      'zh-HK': 'https://aiwill-planner.cn/terms',
      'x-default': 'https://aiwill-planner.cn/terms',
    },
  },
};
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-4 py-10 sm:py-14">
        ...
        <div className="prose prose-slate max-w-none text-slate-700 space-y-6">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li><strong>智能版</strong>: ¥19.9 - 系统化生成文书参考 (全站唯一标准产品)</li>
              <li><strong>定制服务</strong>: 面向跨境 / 股权 / 大额资产 / 再婚多套房产等复杂场景, 资产规划专业人士 1 对 1 对接; 价格根据场景复杂度评估, 请在 <Link href="/contact" className="text-amber-700 hover:underline">/contact</Link> 留言了解详情</li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li><strong>已生成文书 (智能版)</strong>: 7 天内可申请全额退款, 无理由</li>
              <li><strong>定制服务</strong>: 已启动定制流程后不支持退款 (按定制服务协议执行)</li>
