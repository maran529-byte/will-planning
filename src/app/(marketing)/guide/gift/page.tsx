...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      'zh-CN': 'https://aiwill-planner.cn/guide/gift',
      'zh-HK': 'https://aiwill-planner.cn/guide/gift',
      'x-default': 'https://aiwill-planner.cn/guide/gift',
    },
  },
};
  ...
  return (
    <GuideArticle
      ...
      faqs={[
        {
          q: '房产赠与在过户登记前, 可以撤销吗?',
          a: '可以. 根据民法典第六百五十八条, 赠与人在转移登记前可撤销赠与 (一般情形). 但以下情形不可撤销: 1) 经过公证的赠与; 2) 依法办理过户登记的不动产赠与; 3) 因受赠人严重侵害赠与人或近亲属、不履行抚养义务、不履行约定义务, 法定可撤销权也已转移.',
        },
        {
          q: '什么情况下必须办理赠与公证?',
          a: '赠与本身无需公证, 但以下情形建议或必须公证: 1) 受赠不动产(部分城市政策要求); 2) 受赠方无房产但日后要转让, 公证可避免日后举证困难; 3) 大额资产赠与且希望放弃任意撤销权; 4) 涉及未成年人受赠. 公证费一般200-1000元/份.',
        },
        {
          q: '股权赠与涉及哪些税费?',
          a: '个人股东股权赠与: 1) 个人所得税20%(按「财产转让所得」, 一般按股权对应净资产核定); 2) 印花税0.05%; 3) 增值税(非上市股权不征). 有限公司股权赠与需通知其他股东, 30天内未答复视为同意放弃优先购买权.',
        },
        {
          q: '赠与、继承、遗嘱, 三种方式应如何选择?',
          a: '三种方式各有优劣: 1) 赠与: 生前转移, 即时见效, 但税费较高(尤其房产), 适合「现在就要给」; 2) 继承: 身后继承, 税费最低(仅公证费、印花税等), 但需被继承人去世才能办; 3) 遗嘱: 灵活指定分配, 适合复杂家庭, 未发生继承前可撤回. 建议按税务、家庭情况综合选择.',
        },
        {
          q: '祖辈隔代赠与 (跳子女一代), 需要什么特殊手续?',
          a: '隔代赠与: 1) 接受赠与时, 受赠人是未成年人, 由其父母作为法定监护人代为接受, 但需注意若父母作为受赠人的代理人可能产生利益冲突, 建议由其他近亲属或公证机构监督; 2) 子女代签接受时需声明「代未成年孙辈接受赠与」; 3) 建议同时订立遗嘱, 避免日后继承纠纷.',
        },
        {
          q: '赠与给子女个人, 婚后是否属于夫妻共同财产?',
          a: '关键看是否明确「只赠与受赠人本人」. 民法典规定: 婚前赠与默认个人财产; 婚后赠与, 未明确表示只赠与受赠人本人的, 默认夫妻共同财产. 建议赠与协议中明确写明「本赠与仅赠与受赠人本人, 不包含其配偶」, 必要时办理公证或不动产登记中心备案.',
        },
      ]}
    >
      <section>
      ...
      <section>
        ...
        <p className="mt-3">
          ...
          {' '}: ¥19.9 系统化生成 (含税费测算); 复杂场景 (跨境 / 股权 / 大额资产) 可
