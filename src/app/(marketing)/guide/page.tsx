      ...
      <main className="max-w-5xl mx-auto px-4 py-8 sm:py-12">
        ...
        <section className="mt-12 bg-white rounded-2xl p-6 sm:p-8 shadow-sm">
          ...
          <div className="space-y-4 text-sm text-slate-700 leading-relaxed-cn">
            ...
            <div>
              <h3 className="font-semibold text-slate-800 mb-1">智能版和定制服务区别?</h3>
              <p>智能版 ¥19.9: 问卷 + 系统化生成 + PDF / Word 导出. 复杂场景 (跨境 / 股权 / 大额资产) 可 <Link href="/contact" className="text-amber-700 hover:underline">留言定制服务</Link>, 由资产规划专业人士 1 对 1 对接.</p>
            </div>
            <div>
              <h3 className="font-semibold text-slate-800 mb-1">数据安全吗?</h3>
              <p>业务数据由 Supabase (PostgreSQL + RLS) 提供, PII 字段 AES-256 加密, 30 天可申请彻底删除. 详情见 <Link href="/privacy" className="text-amber-700 hover:underline">隐私政策</Link>.</p>
            </div>
          </div>
        </section>
