    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-800 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-slate-400">aiwill-planner 内部使用</p>
        </div>
        ...
        >
          ...
          <button
            ...
            className="w-full rounded-lg bg-amber-500 hover:bg-amber-600 disabled:bg-slate-600 disabled:cursor-not-allowed text-white font-semibold py-3 transition"
          >
            {loading ? '登录中...' : '登录'}
          </button>
        </form>
        ...
        <p className="mt-6 text-center text-xs text-slate-500">
          <Link href="/" className="hover:text-slate-300">← 返回首页</Link>
        </p>
      </div>
    </main>
  );
